...
// (in-package plum_server_client.srv)
...
class AddInitRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AddInitRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AddInitRequest
    let len;
    let data = new AddInitRequest(null);
  ...
  static datatype() {
    ...
    return 'plum_server_client/AddInitRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddInitRequest(null);
...
class AddInitResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AddInitResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AddInitResponse
    let len;
    let data = new AddInitResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'plum_server_client/AddInitResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddInitResponse(null);
...
module.exports = {
  Request: AddInitRequest,
  Response: AddInitResponse,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'plum_server_client/AddInit'; }
};
